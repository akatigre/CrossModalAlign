...
def create_image_S(generator, latent, args):
    with torch.no_grad():
        style_space, style_names, noise_constants = encoder(generator, latent)
        img_orig = decoder(generator, style_space, latent, noise_constants, args)
...
def manipulate_image(style_space, style_names, noise_constants, generator, latent, args, alpha=5, t=None, s_dict=None, device="cuda:0"):
    ...
    img_gen = decoder(generator, manip_codes, latent, noise_constants, args)
